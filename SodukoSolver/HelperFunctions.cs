...
namespace SodukoSolver
{
    public static class HelperFunctions
    {
        ...
        public static int[,] CreateBoard(int rows, int cols, string boardString)
        {
            // create a new board
            int[,] board = new int[rows, cols];

            // copy the board string to the board
            CopyBoardStringToBoard(rows, cols, boardString, board);
        ...
        private static void CopyBoardStringToBoard(int rows, int cols, string boardString, int[,] board)
        {
